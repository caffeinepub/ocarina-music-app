...
export class Backend implements backendInterface {
    ...
    async getAllFingerings(): Promise<Array<[string, Fingering]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFingerings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSequences(): Promise<Array<Sequence>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSequences();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveFingering(arg0: string, arg1: Fingering): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveFingering(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSequence(arg0: Sequence): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSequence(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
